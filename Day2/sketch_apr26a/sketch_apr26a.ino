...
void loop()
{
  ...
  // Follow Wall
  else if (sensorValues[0]!=follow && sensorValues[1] != follow && sensorValues[2] !=follow && sensorValues[3] != follow && sensorValues[4]!= follow && sensorValues[5] != follow && sensorValues[6] != follow && sensorValues[7] != follow  && sensorRight!=follow && sensorLeft!=follow && Sonar_distance1 < 25)
  {
