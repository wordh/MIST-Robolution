...
{  
  ...
  */
  ...
  else if (sensorRight == follow && (sensorValues[2]!= follow && sensorValues[3] !=follow && sensorValues[4]!=follow && sensorValues[5]!=follow))
  {
  ...
  else if (sensorLeft == follow && (sensorValues[2]!= follow && sensorValues[3] !=follow && sensorValues[4]!=follow && sensorValues[5]!=follow) )
  {
...
void sensorRead()
{
  ...
  Serial.println(); // uncomment this line if you are using raw values
   ...
   sensorLeftBack = digitalRead(24);
   if (sensorLeftBack == 1)
   {
     sensorLeftBack=0;
   }
   else sensorLeftBack =1;
